...
export class About {
  ...
  'Fora do trabalho, gosto de praticar esportes e aproveitar atividades ao ar livre, especialmente corrida, ciclismo e conhecer lugares novos. Não costumo acompanhar séries ou filmes logo no lançamento, mas quando resolvo assistir algum tempo depois, geralmente acabo maratonando tudo de uma vez. Também sou apaixonado por música, principalmente rock clássico e alternativo, embora escute um pouco de tudo. Nas horas livres, gosto de assitir filmes com a minha mulher.',
